...
class Menu(MusicInterface):
    def draw_menu(self):
        Main.MENU_CANVAS = Canvas(Main.ROOT, width=Main.SETTINGS.width, height=75, bg=themes[Main.SETTINGS.theme]["second_color"], highlightthickness=1, highlightbackground="grey9")
